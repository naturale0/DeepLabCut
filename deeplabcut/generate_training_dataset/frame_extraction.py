...
def extract_frames(config, mode='automatic', algo='kmeans', crop=False, userfeedback=True,
                   cluster_step=1, cluster_resizewidth=30, cluster_color=False, opencv=True):
    """
            ...
            if askuser=='y' or askuser=='yes' or askuser=='Ja' or askuser=='ha': # multilanguage support :)
                ...
                if crop == True:
                    ...
                    if output_path.exists() :
                        ...
                        # Display the image
                        ax.imshow(image)
                        cid = RectangleSelector(ax, line_select_callback, drawtype='box', useblit=True,button=[1],
